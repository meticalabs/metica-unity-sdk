...
internal class AndroidDelegate : PlatformDelegate
{
    ...
    public void ShowInterstitial(string interstitialAdUnitId, string? placementId)
    {
        ...
        MeticaAds.Log.LogDebug(() => $"{TAG} About to call Android showInterstitial method with placementId={placementId}");
        _unityBridgeAndroidClass.CallStatic("showInterstitial", interstitialAdUnitId, placementId, callback);
    ...
    public void ShowRewarded(string rewardedAdUnitId, string? placementId)
    {
        ...
        MeticaAds.Log.LogDebug(() => $"{TAG} About to call Android showRewarded method with placementId={placementId}");
        _unityBridgeAndroidClass.CallStatic("showRewarded", rewardedAdUnitId, placementId, callback);
